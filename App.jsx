...
const APP_VERSION = (typeof window !== "undefined" && window.__FT_VERSION) || "2.1.0";
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 max-w-2xl mx-auto w-full">
        ...
        {type === "memorization" && (
          <>
            ...
            <Field>
              <RefBox refsText="" inserter={<RefInserter onInsert={(ref) => set({ note: appendRef(record.note, ref) })} />}>
